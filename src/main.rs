  ...
  p.SIM.scgc5.write(|w| w.porta().variant(mkl25z4::sim::scgc5::PORTA_A::_1)
  .portb().variant(mkl25z4::sim::scgc5::PORTB_A::_1)
  .portd().variant(mkl25z4::sim::scgc5::PORTD_A::_1)
  );
  ...
  if pcra13.read().mux().variant() != mkl25z4::porta::pcr::MUX_A::_001 {  
    ...
    pcra13.write(|w| w.mux().variant(mkl25z4::porta::pcr::MUX_A::_001)
                      .irqc().variant(mkl25z4::porta::pcr::IRQC_A::_1000));
  ...
  if pcrd01.read().mux().variant() != mkl25z4::portd::pcr::MUX_A::_001 {  // it seems to stop here
